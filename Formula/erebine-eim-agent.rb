...
class ErebineEimAgent < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Erebine/binaries/releases/download/v2.2.0/erebine-eim-agent-Darwin-arm64"
      version "1.10.0"
  ...
  on_linux do
    url "https://github.com/Erebine/binaries/releases/download/v2.2.0/erebine-eim-agent-Linux-x86_64"
    version "2.0.0"
